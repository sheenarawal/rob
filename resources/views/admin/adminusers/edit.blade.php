@extends('layouts.admin_layout', ['title' => __('User Edit')])
                        ...
                        <form method="post" action="{{ route('user.update', $user->id) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('fname') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="fname" id="input-name" class="form-control form-control-alternative{{ $errors->has('fname') ? ' is-invalid' : '' }}" placeholder="{{ __('First Name') }}" value="{{ old('fname', $user->first_name) }}" required autofocus>
                                    ...
                                    <input type="text" name="lname" id="input-name" class="form-control form-control-alternative{{ $errors->has('lname') ? ' is-invalid' : '' }}" placeholder="{{ __('Last Name') }}" value="{{ old('lname', $user->last_name) }}" required autofocus>
