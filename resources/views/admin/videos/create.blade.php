@extends('layouts.admin_layout', ['title' => __('Videos Create')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">{{ __('Create Videos') }}</h3>
                        </div>
                    ...
                    <div class="card-body">
                        <form class="" action="{{route('videos.store')}}" id="uploadForm" onsubmit="return false" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
