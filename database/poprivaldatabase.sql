...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2021 at 07:17 AM
...
--
-- Database: `poprivaldatabase`
--

-- --------------------------------------------------------

--
-- Table structure for table `auctioneers`
--
...
CREATE TABLE `auctions` (
  ...
  `auction_notice` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bidding_notes` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sellerid` int(11) NOT NULL,
  `auctioneerid` int(11) NOT NULL,
  ...
  `shipping_pickup` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `bidders` (
  ...
  `status` tinyint(4) NOT NULL,
  `hide_username` tinyint(4) NOT NULL,
...
--
-- Table structure for table `bidding_items`
--
...
CREATE TABLE `payment_methods` (
  ...
  `monthexpiry` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `yearexpiry` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `billing_postal` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Admin Admin', 'admin@gmail.com', '2020-08-13 07:47:23', '$2y$10$yS5MymFaeKvBx.U6kcqSaetUswTjIs4fF67ok7T/yRBy5Eb2PmlPe', NULL, '2020-08-13 07:47:23', '2020-09-03 22:33:03');
...
--
-- Indexes for table `bidding_items`
--
...
--
-- AUTO_INCREMENT for table `auctioneers`
--
ALTER TABLE `auctioneers`
...
--
-- AUTO_INCREMENT for table `bidding_items`
--
ALTER TABLE `bidding_items`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
